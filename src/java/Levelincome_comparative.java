...
@WebServlet("/Levelincome_comparative")
public class Levelincome_comparative extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sqlQuery = "{CALL LevelincomeRevenue(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)}";
            ...
            if (level.equals("2") || "3".equals(level)|| "4".equals(level)) {
                String sqlQuery2 = "{CALL LevelincomeCost(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)}";
            ...
            String sqlQuery1 = "{CALL LevelincomeExpense(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)}";
